 ...
 * adding to the rear and removing from the front.
...
public interface QueueInterface<T> {
    ...
    /**
     * Adds {@code elem} to the end of this {@link QueueInterface}. This operation
     * should execute in constant time. That is, it should be executed in O(1).
     * For convenience, this method returns the modified {@link QueueInterface}.
     * @param elem
    ...
    /**
     * Removes the first element from this {@link QueueInterface} and returns it.
    ...
    /**
     * Returns the number of elements in this {@link QueueInterface}. This operation
     * should execute in constant time. That is, it should be executed in O(1).
    ...
    /**
     * Returns a nicely formatted String representing this {@link QueueInterface}.
     * The returned String starts with an open square bracket '[' and ends with a
     * close square bracket ']'. Each element in the Queue should then be written
     * using its toString() method. The elements are separated by a comma ','
     * and a space ' '. There should be no space between the open bracket and the
     * first element and no space between the close bracket and the last element.
     * <pre>
     * Examples:
     * An empty Queue : []
